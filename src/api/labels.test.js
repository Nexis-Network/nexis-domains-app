...
describe('saveName', () => {
  it('should save all labels to localStorage (2)', () => {
    const name = 'vitalik.nzt'
    const nameArray = ['vitalik', 'nzt']
    const hashes = [
  ...
  it('should save all labels to localStorage (3)', () => {
    const name = 'awesome.vitalik.nzt'
    const nameArray = ['awesome', 'vitalik', 'nzt']
    const hashes = [
...
describe('parseName', () => {
  ...
  it('should parse all the labels (3) and return the encoded string', () => {
    const name = `0x${blahblahHash}.vitalik.nzt`
    const encodedName = `[${blahblahHash}].vitalik.nzt`
    const parsedName = parseName(name)
