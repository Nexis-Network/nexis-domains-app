  ...
  return (
    <>
      <FaqContainer>
        ...
        <Section question="Is ENS only for storing an Nexis address?">
        ...
        <Section question="I am stuck at step 2">
          ...
          make sure that the Nexis blockchain has progressed. If this continues
        ...
        <Section question="My transaction at step 3 failed">
          ...
          registered with enough NZT. Please try again from step 3.
          <br />
        ...
        <Section question="I cannot see the names I registered on OpenSea nor on my wallet">
          ...
          site or your NZT address under the name section, your name is
        ...
        <Section question="What is the difference between the Registrant and Controller?">
          If your Nexis address is set as the Controller you can change the
        ...
        <Section question="What is a Primary ENS Name record?">
          A Primary ENS Name record (formerly Reverse Record) makes your Nexis
          address point to an ENS name. This allows dapps to find and display
          your ENS name when you connect to them with your Nexis account. This
        ...
        <Section question="How do I transfer my name?">
          ...
          names, it may be a good idea for you to set the NZT Address record to
          their Nexis address, set the controller, then transfer the name.
          <br />
        ...
        <Section question="What happens if I forget to extend the registration of a name?">
          ...
          released name continues to resolve your NZT address until the new
          owner overwrites it.
        </Section>

        <Section question="I lost access to the Nexis account that owns a name I registered. Can I still extend its registration period?">
          Any Nexis account can pay to extend the registration of any ENS name,
